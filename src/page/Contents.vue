      ...
      <div class="container">
        ...
        <div class="row">
          <div class="content col-xl-5 d-flex flex-column">
            <!-- <img src="@/resources/img/hero-img.png" class="img-fluid" alt="" height="100%"> -->
            <img src="@/resources/img/aptImg.jpg" class="img-fluid" alt="">
          </div>
          <div class="col-xl-7">
              ...
              <div class="row">
                ...
                <div class="col-lg-6 d-flex align-items-stretch mt-4" data-aos="zoom-in" data-aos-delay="100">
                  <div class="icon-box iconbox-teal">
                    ...
                    <h4><a href="/board">게시판</a></h4>
                    <p>게시판을 볼 수 있습니다. 단, 로그인 시에만 글 작성이 가능합니다.</p>
                  </div>
                </div>
              </div>
            </div><!-- End .content-->
