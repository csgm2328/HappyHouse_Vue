<template>
  <section id="pricing" class="pricing">
	...
	<div class="row gy-8">
		<div class="col-lg-0">
			<div class="portfolio-details portfolio-info" align="center"><br>
				<h2>제목을 수정하세요</h2><br>
...
export default {
    ...
    methods: {
        updateBoard(){
            axios
                .put(`http://localhost:9999/board/update/${this.boardNum}`, {
                    no : this.boardNum,
                    title : this.title,
                    writer : this.writer,
    ...
    created() {
        axios
            .get(`http://localhost:9999/board/${this.$route.params.no}`)
            .then(({data})=>{
